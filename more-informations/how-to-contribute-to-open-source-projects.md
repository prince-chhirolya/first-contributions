...
TL;DR: If you're eager to make your first pull request to an open source project, follow the instructions in the [CONTRIBUTING.md](https://github.com/Chhirolya/first-contributions/blob/main/CONTRIBUTING.md).
